...
public class TabManager {
    ...
    private static SharedPreferences getSharedPreferences() {
        return KustawayApplication.getApplication()
    ...
    public static class Tab {
        ...
        public String getName() {
            if (id == TIMELINE_TAB_ID) {
                return KustawayApplication.getApplication().getString(R.string.title_main);
            } else if (id == INTERACTIONS_TAB_ID) {
                return KustawayApplication.getApplication().getString(R.string.title_interactions);
            } else if (id == DIRECT_MESSAGES_TAB_ID) {
                return KustawayApplication.getApplication().getString(R.string.title_direct_messages);
            } else if (id == FAVORITES_TAB_ID) {
                return KustawayApplication.getApplication().getString(R.string.title_favorites);
            } else if (id <= SEARCH_TAB_ID) {
                return KustawayApplication.getApplication().getString(R.string.title_search) + ":" + name;
            } else {
                return name;
            }
        }
