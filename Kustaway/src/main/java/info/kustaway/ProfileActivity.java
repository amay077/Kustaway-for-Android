...
import info.kustaway.fragment.profile.DescriptionFragment;
import info.kustaway.fragment.profile.FavoritesListFragment;
import info.kustaway.fragment.profile.FollowersListFragment;
import info.kustaway.fragment.profile.FollowingListFragment;
import info.kustaway.fragment.profile.SummaryFragment;
import info.kustaway.fragment.profile.UserListMembershipsFragment;
import info.kustaway.fragment.profile.UserTimelineFragment;
import info.kustaway.model.Profile;
import info.kustaway.model.TwitterManager;
import info.kustaway.task.ShowUserLoader;
    ...
    private class ReportSpamTask extends AsyncTask<Long, Void, Boolean> {
        ...
        protected Boolean doInBackground(Long... params) {
            ...
            try {
                ...
                info.kustaway.model.Relationship.setBlock(userId);
                return true;
            } catch (Exception e) {
                e.printStackTrace();
                return false;
    ...
    private class DestroyBlockTask extends AsyncTask<Long, Void, Boolean> {
        ...
        protected Boolean doInBackground(Long... params) {
            ...
            try {
                ...
                info.kustaway.model.Relationship.removeBlock(userId);
                return true;
            } catch (Exception e) {
                e.printStackTrace();
                return false;
    ...
    private class CreateOfficialMuteTask extends AsyncTask<Long, Void, Boolean> {
        ...
        protected Boolean doInBackground(Long... params) {
            ...
            try {
                ...
                info.kustaway.model.Relationship.setOfficialMute(userId);
                return true;
            } catch (Exception e) {
                e.printStackTrace();
                return false;
    ...
    private class DestroyOfficialMuteTask extends AsyncTask<Long, Void, Boolean> {
        ...
        protected Boolean doInBackground(Long... params) {
            ...
            try {
                ...
                info.kustaway.model.Relationship.removeOfficialMute(userId);
                return true;
            } catch (Exception e) {
                e.printStackTrace();
                return false;
    ...
    private class CreateNoRetweetTask extends AsyncTask<Long, Void, Boolean> {
        ...
        protected Boolean doInBackground(Long... params) {
            ...
            try {
                ...
                info.kustaway.model.Relationship.setNoRetweet(userId);
                return true;
            } catch (Exception e) {
                e.printStackTrace();
                return false;
    ...
    private class DestroyNoRetweetTask extends AsyncTask<Long, Void, Boolean> {
        ...
        protected Boolean doInBackground(Long... params) {
            ...
            try {
                ...
                info.kustaway.model.Relationship.removeNoRetweet(userId);
                return true;
            } catch (Exception e) {
                e.printStackTrace();
                return false;
